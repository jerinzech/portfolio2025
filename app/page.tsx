  ...
  return (
    ...
    <>
      <div style={{
        ...
        <div className="homepage-body max-w-360 mx-auto min-h-[85vh] flex flex-col justify-center items-center">
          <CFHomepage />
        </div>
        <div className="homepage-footer max-w-360 mx-auto max-h-[3vh]">
          Footer
        </div>
      </div >
