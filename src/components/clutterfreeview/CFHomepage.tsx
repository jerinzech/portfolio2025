...
function CFHomepage() {
  return (
    <div className="CFHomepage-text border flex-row items-center text-justify w-4/5 md:w-2/3 lg:w-[7/13] h-min text-[16px] lg:text-[24px] font-['Alexandria'] font-extralight" >
